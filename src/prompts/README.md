...
| 文件 | 用途 | 主要调用位置 |
|------|------|--------------|
| `evolution/classify_relations_system.txt` | Event 生命周期约束分类系统提示 | `evolution/relation_processor.py` |
| `evolution/classify_relations_user.txt` | Event 生命周期约束分类用户模板 | `evolution/relation_processor.py` |
