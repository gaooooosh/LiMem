...
RECALL_MAX_CANDIDATES = int(os.getenv("RECALL_MAX_CANDIDATES", "30"))
RECALL_TEMPORAL_WINDOW = int(os.getenv("RECALL_TEMPORAL_WINDOW", "604800"))
RECALL_TEMPORAL_LIMIT = int(os.getenv("RECALL_TEMPORAL_LIMIT", "20"))
RECALL_ENTITY_LIMIT = int(os.getenv("RECALL_ENTITY_LIMIT", "20"))
RECALL_SEMANTIC_LIMIT = int(os.getenv("RECALL_SEMANTIC_LIMIT", "20"))
RECALL_SEMANTIC_THRESHOLD = float(os.getenv("RECALL_SEMANTIC_THRESHOLD", "0.65"))
RECALL_STATE_LIMIT = int(os.getenv("RECALL_STATE_LIMIT", "10"))
RECALL_REFERENCE_LIMIT = int(os.getenv("RECALL_REFERENCE_LIMIT", "10"))

RECALL_WEIGHT_TEMPORAL = float(os.getenv("RECALL_WEIGHT_TEMPORAL", "0.15"))
RECALL_WEIGHT_ENTITY = float(os.getenv("RECALL_WEIGHT_ENTITY", "0.25"))
...
RELATION_MIN_CONFIDENCE = float(os.getenv("RELATION_MIN_CONFIDENCE", "0.5"))
