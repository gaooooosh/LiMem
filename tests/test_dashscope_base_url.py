...
class TestDashScopeBaseUrlNormalization(unittest.TestCase):
    def test_normalizes_openai_compatible_base_url_for_sdk(self):
        self.assertEqual(
    ...
    def test_normalizes_openai_compatible_chat_completions_url_for_sdk(self):
        self.assertEqual(
            normalize_dashscope_base_url(
    ...
    def test_two_stage_extractor_normalizes_constructor_base_url(self):
        ...
        self.assertEqual(extractor.base_url, "https://dashscope.aliyuncs.com/api/v1")

    def test_dynamic_evolution_config_normalizes_constructor_base_url(self):
        config = DynamicEvolutionConfig(
            llm_base_url="https://dashscope.aliyuncs.com/compatible-mode/v1"
        )
        self.assertEqual(config.llm_base_url, "https://dashscope.aliyuncs.com/api/v1")
